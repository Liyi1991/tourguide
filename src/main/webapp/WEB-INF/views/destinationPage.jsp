            ...
            <div class="user-block">
             ...
             <div class="head-search" id="head-search">
                <form name="head-search-form" id="head-search-form" action="search" method="post">
                    <div class="s-input">
                        <input id="head-search-word" name="query" autocomplete="off" type="text" placeholder="search destinations/scenes/notes" />
                    </div>
...
<div class="screen clearfix">
                <div class="r-main">
                           <a class="photo" href="" target="_blank">
                            <img src="${pageContext.request.contextPath}/resources/image/${destination.image}/${imageName}" width="680" height="360">
                            <div class="text">
