...
<div id="container" data-cs-t="destination details">
...
<div class="row row-travels">
    <div class="wrapper">
         ...
         <div class="hd">
            <ul class="tabs">
                <li  class="on"><a href="destinationNote?destinationID=${destination.destinationID}">Hottest Notes</a></li>
               <li  class="on"><a href="destinationNote_latest?destinationID=${destination.destinationID}">Latest Notes</a></li>
                            </ul>
            <span class="r-extra">
                   
                    <a href="writenote?destinationID=${destination.destinationID}&username=${userObj.username}" class="btn-addPost"><i></i>Post new note</a>
            </span>
        </div>
  ...
  <div class="post-list">
    <ul>
            ...
            <span class="status"><i class="icon_comment"></i>${listValue.noteReviewNum}</span>
        </li>
        ...
        <span class="count">Total<span> ${length} </span>Notes </span>                        
            </div>
